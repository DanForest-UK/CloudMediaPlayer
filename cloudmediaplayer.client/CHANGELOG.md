...
- Create Angular project with ng: `ng new cloudmediaplayer.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`cloudmediaplayer.client.esproj`).
